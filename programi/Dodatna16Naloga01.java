...
public class Dodatna16Naloga01 {
    ...
    // Metoda, ki izpise vse vrstice piramide visine visna od i-te (vr-te) vrstice dalje
    public static void piramida(int vr, int visina) {

        // Preverimo, ce smo ze izpisali celtno piramido
        if (vr > visina) {
            return;
        }
